      ...
      <div className="space-y-4">
        ...
        {address ? (
          <>
            ...
            >
              {isDeploying ? 'Deploying...' : 'Coin My Book'}
            </button>
            {deployedTokenAddress && (
              <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded text-green-800 text-center break-all">
                ...
                <div className="mt-2 font-semibold text-green-700">Congratulation! Your content is stored forever on Base!</div>
              </div>
            )}
          </>
        ) : (
          <p className="text-yellow-400 text-sm text-center mt-2">
            Connect your wallet to deploy token
          </p>
        )}
      </div>
    </Card>
      ...
      <div className="space-y-4">
        ...
        {address ? (
          <>
            ...
            >
              {isDeploying ? 'Deploying...' : 'Coin My Salad'}
            </button>
            {deployedTokenAddress && (
              <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded text-green-800 text-center break-all">
                <div className="font-semibold">Token Address:</div>
      ...
      <div className="space-y-4">
        ...
        {address ? (
          <>
            ...
            >
              {isDeploying ? 'Deploying...' : 'Coin My Drama'}
            </button>
            {deployedTokenAddress && (
              <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded text-green-800 text-center break-all">
                <div className="font-semibold">Token Address:</div>
      ...
      <div className="space-y-4">
        ...
        {address ? (
          <>
            ...
            >
              {isDeploying ? 'Deploying...' : 'Coin My Sea'}
            </button>
            {deployedTokenAddress && (
              <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded text-green-800 text-center break-all">
                <div className="font-semibold">Token Address:</div>
